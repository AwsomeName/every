...
baseip = "0.0.0.0:8081"
baseip = "i-2.gpushare.com:58070"
url = "http://" + baseip + "/api/v1/chat/"
url_upl_wav_file = "http://" + baseip + "/api/v1/upload_wav_file"
url_upl_img_file = "http://" + baseip + "/api/v1/upload_img_file"
...
data = {'date_str': "2024-04-29_20:00:00", 'user_id': '100100100', 'input_str': "图片中是谁"}
result = requests.post(url=url, json=data, headers=headers)
print("txt req:", result.text)
